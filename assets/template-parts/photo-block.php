...
<div class="photo-suggested" data-photo-src="<?php echo get_the_post_thumbnail_url(); ?>" 
                             ...
                             data-photo-category="<?php echo esc_attr(get_the_terms(get_the_ID(), 'categorie_photo')[0]->name); ?>">
     ...
     <div class="overlay"><!--superposer une icône d'œil et une icône pour le mode plein écransur l'image-->
          <div class="overlay__full">
            ...
            <a href="<?php echo get_the_permalink(); ?>" class="open-photopage icon">
                ...
                <img src="<?php echo  get_stylesheet_directory_uri(); ?>/assets/img/icon_eye.png" alt="Ouvrir la page de la photo">
            </a>
            <img class="fullsize icon" src="<?php echo  get_stylesheet_directory_uri(); ?>/assets/img/icon_fullscreen.png" alt="Voir l'image en plein écran">
            ...
            <p class="overlay-category overlay-text"><?php echo get_the_terms(get_the_ID(), 'categorie_photo')[0]->name; ?></p>                                
          </div>
     </div>
