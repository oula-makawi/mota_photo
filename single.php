        ...
        <div class="main-content">
            <div class="single-photo-content">
                    <div class="infos-container">
                        ...
                        <p> Catégorie : <?php echo get_the_terms(get_the_ID(), 'categorie_photo')[0]->name; ?></p>                 
                        <p> Format : <?php echo get_the_terms(get_the_ID(), 'format_photo') [0]->name; ?></p>
                        <p> Type : <?php echo  get_the_terms(get_the_ID(),'type_photo') [0]->name; ?></p>
                        ...
                        <div class="arrows">
                            <?php if ($previouspost) : ?>                                
                                ...
                                <a href="<?php echo get_permalink($previouspost); ?>" class="arrow-link arrow-left">
                                    ...
                                    <img class="arrow arrow-left" src="<?php echo  get_stylesheet_directory_uri(); ?>/assets/img/arrow-left.svg.png" alt="Arrow for previous picture">
                            ...
                            <?php if ($nextpost) : ?>
                                ...
                                <a href="<?php echo get_permalink($nextpost); ?>" class="arrow-link arrow-right">
                                    ...
                                    <img class="arrow arrow-right" src="<?php echo  get_stylesheet_directory_uri(); ?>/assets/img/arrow-right.svg" alt="Arrow for next picture">
    ...
    <div class="gallery">
          ...
          <div class="gallery-container">
            <?php
             ...
             $current_category = get_the_terms($current_post_id, 'categorie_photo');//Récupère les termes de la taxonomie 'categorie' pour la photo actuelle
             ...
             $args = array(//Crée un tableau $args pour les arguments de la requête
                  'post_type' => 'portfolio',//Spécifie le type de publication (photos)
